    ...
    <section className="py-20 bg-[#09090B] border-t border-[#27272A]/50 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          {/* Before Column */}
          <Card className="bg-[#18181B] border-[#EF4444]/30 p-6 space-y-5 relative">
            <div className="flex items-center gap-2 pb-3 border-b border-[#27272A]">
              <XCircle className="h-5 w-5 text-[#EF4444]" />
              <h3 className="font-bold text-[#FAFAFA] text-base">Without ABTalks (Tutorial Trap)</h3>
            </div>
            <div className="space-y-3">
              {mindsetShift.map((item, idx) => (
                <div key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm text-[#A1A1AA]">
          ...
          {/* After Column */}
          <Card className="bg-[#18181B] border-[#22C55E]/40 p-6 space-y-5 relative shadow-[0_0_30px_rgba(34,197,94,0.15)]">
            <div className="flex items-center gap-2 pb-3 border-b border-[#27272A]">
              <CheckCircle2 className="h-5 w-5 text-[#22C55E]" />
              <h3 className="font-bold text-[#FAFAFA] text-base">With ABTalks 60-Day Challenge</h3>
            </div>
            <div className="space-y-3">
              {mindsetShift.map((item, idx) => (
                <div key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm text-[#FAFAFA] font-medium">
