...
export function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="py-20 bg-[var(--background)] border-t border-[var(--border)] text-[var(--foreground)] relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {benefits.map((benefit, idx) => {
            ...
            return (
              ...
              >
                <Card className="bg-[var(--card)] border-[var(--border)] text-[var(--foreground)] p-6 sm:p-8 h-full flex flex-col justify-between hover:border-[var(--primary)] transition-all group glass-card">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold text-[var(--foreground)] group-hover:text-[var(--primary)] transition-colors">
                        {benefit.title}
                      </h3>
                  ...
                  <div className="pt-4 border-t border-[var(--border)] mt-5 flex items-center text-xs text-[var(--foreground)] font-medium gap-2">
