      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        {insights.map((item) => {
          ...
          return (
            <div
              key={item.label}
              className="p-3.5 rounded-2xl bg-[#18181B] border border-zinc-800 flex flex-col justify-between"
            >
              <div
              ...
              <div>
                ...
                <p className="text-sm font-black text-zinc-100 mt-0.5 tabular-nums">
                  {item.value}
                </p>
              </div>
            </div>
